...
public class Aims {
    ...
    public static void initSetup() {
        ...
        DigitalVideoDisc dvd1 = new DigitalVideoDisc("Jurassic Park", "Sci-Fi", "Steven Spielberg", 87, 19.95f);     
        DigitalVideoDisc dvd2 = new DigitalVideoDisc("The Lord of the Rings: The Fellowship of the Ring", "Fantasy", "Peter Jackson", 87, 74.95f); 
        DigitalVideoDisc dvd3 = new DigitalVideoDisc("Spirited Away", "Animation", 18.99f);
        store.addMedia(dvd1);
        store.addMedia(dvd2);
        store.addMedia(dvd3);

    
        Book book = new Book("White Fang", "Animal Fiction", 20.00f);
        Book book1 = new Book("Life of Pi", "Adventure", 22.00f);
        Book book2 = new Book("The Hobbit", "Fantasy", 120.00f);
        store.addMedia(book);
        ...
        CompactDisc cd3 = new CompactDisc("Baby", "Music","Justin Bieber", 1000.98f);
